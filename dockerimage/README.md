...
**Windows Code Signing using Azure Artifact Signing or codesigning certificate.pfx**  
...
**Create a Windows Installer using InnoSetup - signed with Azure Artifact Signing or .pfx**  
